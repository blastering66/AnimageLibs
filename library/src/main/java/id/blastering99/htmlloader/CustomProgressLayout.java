package id.blastering99.htmlloader;
 ...
 */
public class CustomProgressLayout extends FrameLayout {
    ...
    public CustomProgressLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustomProgressLayout(Context context, AttributeSet attrs, int defStyleAttr) {
